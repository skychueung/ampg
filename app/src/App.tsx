...
function PageTitleProvider({ children }: { children: React.ReactNode }) {
  ...
  else if (pathname.startsWith('/run-comparison')) title = 'Run Comparison'
  else if (pathname.startsWith('/sequence-explorer')) title = 'Sequence Explorer'
  ...
  else if (pathname === '/') title = 'AMPGen Home'
      ...
      <PageTitleProvider>
        <Suspense fallback={<PageLoading />}>
          <Routes>
            ...
            <Route path="/admin" element={<ServerMode />} />
