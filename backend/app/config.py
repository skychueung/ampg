...
SERVER_PRODUCTION_SINGLE_RUN_LIMIT = int(os.getenv("SERVER_PRODUCTION_SINGLE_RUN_LIMIT", "100"))
...
AMPGEN_SERVER_ONLY = os.getenv("AMPGEN_SERVER_ONLY", "false").lower() == "true"
AMPGEN_BACKEND_PORT = int(os.getenv("AMPGEN_BACKEND_PORT", "18701"))
